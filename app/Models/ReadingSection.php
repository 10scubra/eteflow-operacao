...
{
    protected $fillable = ['reading_round_id', 'section_key', 'label', 'status', 'editing_by', 'editing_started_at', 'started_by', 'completed_by', 'last_edited_by', 'started_at', 'completed_at', 'lock_version'];
